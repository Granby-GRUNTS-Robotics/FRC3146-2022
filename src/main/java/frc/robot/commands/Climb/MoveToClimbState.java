  ...
  public void initialize() {
      ...
      switch (climb_state) {
        ...
        case 3:
          ...
          break;
        case 4:
          setStateList(new BIG_CLIMB_ENUM[]{ BIG_CLIMB_ENUM.RATCHET_RATCHETING, BIG_CLIMB_ENUM.ARM_VERTICAL, BIG_CLIMB_ENUM.PIDONE, BIG_CLIMB_ENUM.CLAW_CLOSED, BIG_CLIMB_ENUM.HOOK_OFF_PREV, BIG_CLIMB_ENUM.WAIT, BIG_CLIMB_ENUM.PULL_UNTIL_SWITCH,
