  ...
  public void initialize() {
      ...
      switch (climb_state) {
        ...
        case 1:
          ...
          break;
        case 2:
         setStateList(new BIG_CLIMB_ENUM[]{ BIG_CLIMB_ENUM.RATCHET_RATCHETING, BIG_CLIMB_ENUM.PIDONE, BIG_CLIMB_ENUM.ARM_VERTICAL, BIG_CLIMB_ENUM.CLAW_OPEN, BIG_CLIMB_ENUM.PULL_UNTIL_SWITCH,
                                            BIG_CLIMB_ENUM.CLAW_CLOSED, BIG_CLIMB_ENUM.RACHET_FREE, BIG_CLIMB_ENUM.PIDZERO, BIG_CLIMB_ENUM.HOOK_SWING_UP, BIG_CLIMB_ENUM.ARM_VERTICAL, BIG_CLIMB_ENUM.HOOK_RESTING, BIG_CLIMB_ENUM.RATCHET_RATCHETING, 
                                            BIG_CLIMB_ENUM.PIDONE, BIG_CLIMB_ENUM.HOOK_OFF_PREV, BIG_CLIMB_ENUM.WAIT, BIG_CLIMB_ENUM.PULL_UNTIL_SWITCH,
                                            BIG_CLIMB_ENUM.CLAW_CLOSED, BIG_CLIMB_ENUM.RACHET_FREE, 
                                            BIG_CLIMB_ENUM.ARM_VERTICAL, BIG_CLIMB_ENUM.PIDZERO, BIG_CLIMB_ENUM.HOOK_SWING_UP});
          break;
        case 3:
          setStateList(new BIG_CLIMB_ENUM[]{ BIG_CLIMB_ENUM.RATCHET_RATCHETING, BIG_CLIMB_ENUM.ARM_VERTICAL, BIG_CLIMB_ENUM.CLAW_CLOSED, BIG_CLIMB_ENUM.HOOK_RESTING});
          break;
        case 4:
